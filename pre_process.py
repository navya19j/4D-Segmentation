...
def get_binary_image():
    ...
    for j in range (118,200):
        if (j!=117) and (j!=164): #117
            path_dir = "C:/Users/navya/Desktop/Stuff/IIT/4D segmentation/Data_Navya/Labeled/cell02_EEA1 TagRFP_binary"
            path_fin = "C:/Users/navya/Desktop/Stuff/IIT/4D segmentation/Data_Navya/Labeled_Scaled/cell02_EEA1 TagRFP"
            if (int(j/10)==0):
