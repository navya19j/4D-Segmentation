...
def main(config):
    ...
    pred_mask = os.makedirs(os.path.join(ROOT, "output", CELLNAME, "predicted_mask"), exist_ok=True)
    ...
    print(f"Loaded {len(test_loader)} test images from {os.path.join(ROOT, TEST_DATA, CELLNAME)}.")
